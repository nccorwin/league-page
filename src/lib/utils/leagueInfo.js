/*   STEP 1   */
export const leagueID = "735542296476512256"; // your league ID
export const leagueName = "EPIC Fantasy Football League"; // your league name
...
export const homepageText = `
  <p>Founded in 2010 by our fearless leader, Daniel Chryst, EPIC Fantasy Football League has gone through many phases on its way to becoming an established League of Extraordinary Champions.</p>
  <p>EPIC League features 12 managers across managers from across the US (and sometimes Israel or UAE depending on Markell's weekend plans).</p>
  <p>While many league members have been established since Danny's tenure at UW-Madison, others have joined since his time at Northwestern's PT Masters program.</p>
...
export const managers = [
    {
      ...
      "bio": "Lorem ipsum...",
      "photo": "/managers/danny.jpg", // square ratio recommended (no larger than 500x500)
      ...
      "rival": {
        name: "My own thoughts", // Can be anything (usually your rival's name)
        link: 1, // manager array number within this array, or null to link back to all managers page
        image: "/managers/danny.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
    ...
    },
    {
      ...
      "bio": "Lorem ipsum...",
      "photo": "/managers/nicky.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2014, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "gb", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Loren", // Can be anything (usually your rival's name)
        link: 5, // manager array number within this array, or null to link back to all managers page
        image: "/managers/loren.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
    ...
    },
    {
      ...
      "bio": "Lorem ipsum...",
      "photo": "/managers/loren.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2016, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "gb", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        ...
        image: "/managers/nicky.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
      "favoritePlayer": 96, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
    ...
    },
    {
      ...
      "location": "Madison", // (optional)
      "bio": "Lorem ipsum...",
      "photo": "/managers/boland.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2014, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "gb", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
    ...
    },
    {
      ...
      "bio": "As a lifelong Vikings fan and misery enthusiast, I enjoy building solid teams only to lose in the most heartbreaking ways.",
    ...
    },
    {
      ...
      "location": "Chicago", // (optional)
      "bio": "Lorem ipsum...",
      "photo": "/managers/sally.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2010, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "gb", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
      ...
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Looking to improve my team outside of trades and waiver claims!",
      "tradingScale": 4, // 1 - 10
      "preferredContact": "Text", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
  ]
